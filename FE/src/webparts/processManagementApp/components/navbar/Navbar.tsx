...
export default function PrimarySearchAppBar(): JSX.Element {
  ...
  const renderMenu = (
    ...
    >
      {/* <MenuItem Icon={<PersonOutlineOutlinedIcon />} onClick={handleMenuClose}>Profile</MenuItem> */}
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" style={{ backgroundColor: "rgb(11, 41, 72)", color: "rgb(89, 208, 255)"}}>
        <Toolbar>
          <Search>
            <SearchIconWrapper>
              <SearchIcon />
